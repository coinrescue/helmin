...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='helmin.conf'
CONFIGFOLDER='/root/.helmin'
COIN_DAEMON='helmind'
COIN_CLI='helmin-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/RichieHelmin/Helmin.git'
COIN_TGZ='https://github.com/RichieHelmin/Helmin/releases/download/v1.3.1/linux.tgz'
