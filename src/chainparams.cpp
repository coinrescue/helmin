...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000ced008f0d9359451a6366cf367c77e7c277642b49c2ae290a542547cec1"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1540220972, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 2000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Helmin Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1540220972;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20961082;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x00000ced008f0d9359451a6366cf367c77e7c277642b49c2ae290a542547cec1"));
        assert(genesis.hashMerkleRoot == uint256("0x609a39854ade001bf493f5d81246f9cc6ff8b6ba2545ebc1933c0cfb2b1d2946"));
        

        vSeeds.push_back(CDNSSeedData("seed1.helmin.io", "seed1.helmin.io"));
        vSeeds.push_back(CDNSSeedData("seed2.helmin.io", "seed2.helmin.io"));
        vSeeds.push_back(CDNSSeedData("seed3.helmin.io", "seed3.helmin.io"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1540220972; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1540220973;
        genesis.nNonce = 21213056;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000947273715be504ea423ddc888d7dd758f7c676831913b8d3915f23bcd7e"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Helmin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Helmin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Helmin BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1540220973;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1540220974;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x5c9cf7ff55d9b5e8aebfd9efa2e9d9646aa9fef369b913c4cc1647396d671cac"));
