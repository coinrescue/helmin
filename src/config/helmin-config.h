/* src/config/helmin-config.h.  Generated from helmin-config.h.in by configure.  */
/* src/config/helmin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HLMN_CONFIG_H

#define HLMN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://helmin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Helmin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Helmin Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "helmin"
