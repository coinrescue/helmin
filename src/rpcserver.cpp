...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HLMN features */
        {"helmin", "masternode", &masternode, true, true, false},
        {"helmin", "masternodelist", &masternodelist, true, true, false},
        {"helmin", "mnbudget", &mnbudget, true, true, false},
        {"helmin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"helmin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"helmin", "mnsync", &mnsync, true, true, false},
        {"helmin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"helmin", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use helmind, or the -server option to helmin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Helmin Alert\" admin@foo.com\n"),
...
{
    return "> helmin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27911/\n";
}
