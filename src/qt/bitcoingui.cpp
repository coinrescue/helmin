                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Helmin-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Helmin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and helmin: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Helmin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Helmin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Helmin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Helmin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Helmin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Helmin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Helmin Core help message to get a list with possible Helmin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Helmin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Helmin network", "", count));
}
...
{
    QString strTitle = tr("Helmin Core"); // default title
