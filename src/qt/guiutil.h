...
/** Utility functions used by the HLMN Qt UI.
 */
namespace GUIUtil
{
...
// Render HLMN addresses in monospace font
...
// Parse "helmin:" URI into recipient object, return true on successful parsing
