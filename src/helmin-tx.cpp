...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Helmin Core helmin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  helmin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded helmin transaction") + "\n" +
                               "  helmin-tx [options] -create [commands]   " + _("Create hex-encoded helmin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded helmin transaction
