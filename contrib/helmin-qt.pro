...
RESOURCES += src/qt/helmin.qrc src/qt/helmin_locale.qrc

TRANSLATIONS += src/qt/locale/helmin_bg.ts \
                src/qt/locale/helmin_de.ts \
                src/qt/locale/helmin_en.ts \
                src/qt/locale/helmin_es.ts \
                src/qt/locale/helmin_fi.ts \
                src/qt/locale/helmin_fr.ts \
                src/qt/locale/helmin_it.ts \
                src/qt/locale/helmin_ja.ts \
                src/qt/locale/helmin_pl.ts \
                src/qt/locale/helmin_pt.ts \
                src/qt/locale/helmin_ru.ts \
                src/qt/locale/helmin_sk.ts \
                src/qt/locale/helmin_sv.ts \
                src/qt/locale/helmin_vi.ts \
                src/qt/locale/helmin_zh_CN.ts \
                src/qt/locale/helmin_zh_TW.ts
